package com.egen.serversentevents.service;
...
public class KijoService {
    ...
    public Flux<Kijo> streamKijo(String clientId){
        return kijoStream.filter(kijo -> kijo.getKijoClientId().equals(clientId));
    }
}
